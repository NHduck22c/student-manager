...
<%
    ...
    try {
        ...
        classDetailId = (int) session.getAttribute("classDetailId");
        students = (ArrayList<Student>) session.getAttribute("classStudentDetail");
    } catch (Exception e) {
        e.printStackTrace();
    ...
    <form id="add-form" method="post">
        ...
        <select type="text" name="class_id">
            <%
                ...
                for (ClassInfo classInfo : classInfos) {
            %>
            <option value=<%=classInfo.getId()%> <%= classInfo.getId() == classDetailId ? "selected" : "" %>><%= classInfo.getClassName() %>
            </option>
            <%
                }
            %>
