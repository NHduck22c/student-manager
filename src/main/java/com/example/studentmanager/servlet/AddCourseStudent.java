...
@WebServlet("/" + PageName.ADD_COURSE_STUDENT)
public class AddCourseStudent extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Integer score = Parser.toInt(request.getParameter("score"));
        try {
            if (course_id == null) {
                throw new Exception();
            }
            ...
            if (score != null) {
                courseStudentService.insertCourseStudent(student_id, course_id, score);
            } else {
                courseStudentService.insertCourseStudent(student_id, course_id);
            }
